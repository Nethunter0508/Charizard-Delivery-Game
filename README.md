...
* Collision detection and obstacle interactions
* Victory screen upon completing all deliveries
* User Interface built with TextMeshPro
...
* Trigger and physics interactions
